...
var Component = function () {
  ...
  _createClass(Component, [{
    key: "proxyModel",
    value: function proxyModel(model) {
      var _this = this;

      return new Proxy(model, {
        set: function set(obj, prop, value) {
          obj[prop] = value;
          if (_this.reRender) _this.reRender();
          return true;
        }
      });
    }
...
var Elements = {
  ...
  createHeader: function createHeader(_ref2) {
    var _ref2$textContent = _ref2.textContent,
        textContent = _ref2$textContent === undefined ? ' ' : _ref2$textContent;

    var header = document.createElement('h1');
    header.textContent = textContent;
    return header;
  },
  createContainer: function createContainer(_ref3) {
...
var _Component2 = require('../library/Component');

var _Component3 = _interopRequireDefault(_Component2);

var _Elements = require('../library/Elements');
...
var HomePageComponent = function (_Component) {
  ...
  _createClass(HomePageComponent, [{
    ...
    value: function render() {
      ...
      homePageContainer.appendChild(_Elements2.default.createHeader({
        textContent: 'Ik ben vincent Claeys'
      }));
...
},{"../library/Component":14,"../library/Elements":15}],10:[function(require,module,exports) {
'use strict';
...
exports.HomePageComponent = _HomePage2.default;
},{"./HomePage":12}],4:[function(require,module,exports) {
'use strict';
...
var initApp = function initApp() {
  ...
  var app = new _App2.default(appContainer);
  app.showComponent(new _components.HomePageComponent());
}; // // Element Helpers
...
},{"./sass/main.scss":6,"./App":7,"./components":10}],11:[function(require,module,exports) {
...
//# sourceMappingURL=/src.a06207f1.map